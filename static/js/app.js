...
class ImageTaggingSystem {
    ...
    displayImageInfo() {
        ...
        this.imageInfo.innerHTML = `
            <p><strong>Name:</strong> ${this.currentImage.name}</p>
            <p><strong>Size:</strong> ${sizeKB} KB</p>
            <p><strong>Type:</strong> ${this.currentImage.type}</p>
        `;
    }
    ...
    generateAutoTags() {
        ...
        this.autoTags.innerHTML = autoGeneratedTags.map(tag => 
            `<div class="auto-tag" data-tag="${tag}">${tag}</div>`
        ).join('');
        ...
        this.galleryGrid.innerHTML = imagesToDisplay.reverse().map(img => `
            <div class="gallery-item">
                ...
                <div class="gallery-item-info">
                    ...
                    <div class="gallery-item-date">${new Date(img.timestamp).toLocaleString()}</div>
                </div>
            </div>
        `).join('');
    }
